...
local base = "https://raw.githubusercontent.com/ultra3-dev/AURA-EGG-NOTIFIER/dcf9bab10a874a6dfa4b2186b149b7b3f1e61d3a/"
local files = {
	"AURA_EGG_BOOT.lua",
...
source = source .. "\n" .. game:HttpGet(base .. fileName .. "?v=20260926-2.2.3")
end

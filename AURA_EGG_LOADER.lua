-- AURA EGG NOTIFIER // MODULAR LOADER 2.0.2 ULTRA
...
local base = "https://raw.githubusercontent.com/ultra3-dev/AURA-EGG-NOTIFIER/33489396dac0779b3896a09428148811d9985d8a/"
local files = {
	"AURA_EGG_BOOT.lua",
...
for _, fileName in ipairs(files) do
	source = source .. "\n" .. game:HttpGet(base .. fileName .. "?v=20260925-register-fix-2")
end

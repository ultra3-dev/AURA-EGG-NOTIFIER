...
local base = "https://raw.githubusercontent.com/ultra3-dev/AURA-EGG-NOTIFIER/1e3414da13529104f5eecfd047354b8e732f63c4/"
local files = {
	"AURA_EGG_BOOT.lua",
...
source = source .. "\n" .. game:HttpGet(base .. fileName .. "?v=20260926-2.2.4")
end

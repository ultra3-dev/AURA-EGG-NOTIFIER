...
configUi.panel.BackgroundColor3 = Color3.fromRGB(29, 19, 45)
configUi.panel.BackgroundTransparency = 0.05
...
configUi.panelCorner.CornerRadius = UDim.new(0, 10)
configUi.panelCorner.Parent = configUi.panel

configUi.header = Instance.new("TextLabel")
configUi.header.Position = UDim2.new(0, 12, 0, 8)
configUi.header.Size = UDim2.new(1, -24, 0, 18)
configUi.header.BackgroundTransparency = 1
configUi.header.Text = "CONFIG // ROLES + EMOJIS + LAST SEEN"
configUi.header.TextColor3 = Color3.fromRGB(214, 165, 255)
configUi.header.Font = Enum.Font.Code
configUi.header.TextSize = 10
...
configUi.list.Name = "ConfiguredPets"
configUi.list.Position = UDim2.new(0, 10, 0, 30)
configUi.list.Size = UDim2.new(1, -20, 0, 92)
configUi.list.BackgroundColor3 = Color3.fromRGB(24, 16, 38)
configUi.list.BorderSizePixel = 0
configUi.list.CanvasSize = UDim2.new(0, 0, 0, 0)
configUi.list.ScrollBarThickness = 3
configUi.list.ScrollBarImageColor3 = Color3.fromRGB(151, 91, 211)
configUi.list.Parent = configUi.panel

configUi.listCorner = Instance.new("UICorner")
configUi.listCorner.CornerRadius = UDim.new(0, 6)
configUi.listCorner.Parent = configUi.list

configUi.listBody = Instance.new("Frame")
configUi.listBody.Name = "Rows"
configUi.listBody.Size = UDim2.new(1, -6, 0, 0)
...
configUi.listLayout.Padding = UDim.new(0, 4)
...
configUi.nameBox.Position = UDim2.new(0, 10, 0, 130)
configUi.nameBox.Size = UDim2.new(1, -20, 0, 27)
configUi.nameBox.BackgroundColor3 = Color3.fromRGB(54, 32, 78)
configUi.nameBox.BorderSizePixel = 0
configUi.nameBox.ClearTextOnFocus = false
configUi.nameBox.PlaceholderText = "Nombre exacto de la mascota / huevo"
configUi.nameBox.PlaceholderColor3 = Color3.fromRGB(160, 133, 185)
configUi.nameBox.Text = ""
configUi.nameBox.TextColor3 = Color3.fromRGB(245, 235, 255)
configUi.nameBox.Font = Enum.Font.Code
configUi.nameBox.TextSize = 10
...
configUi.roleBox.Position = UDim2.new(0, 10, 0, 162)
configUi.roleBox.Size = UDim2.new(1, -20, 0, 27)
configUi.roleBox.BackgroundColor3 = Color3.fromRGB(54, 32, 78)
configUi.roleBox.BorderSizePixel = 0
configUi.roleBox.ClearTextOnFocus = false
configUi.roleBox.PlaceholderText = "ID del rol o <@&ID>"
configUi.roleBox.PlaceholderColor3 = Color3.fromRGB(160, 133, 185)
configUi.roleBox.Text = ""
configUi.roleBox.TextColor3 = Color3.fromRGB(245, 235, 255)
configUi.roleBox.Font = Enum.Font.Code
configUi.roleBox.TextSize = 10
...
configUi.emojiBox.Position = UDim2.new(0, 10, 0, 194)
configUi.emojiBox.Size = UDim2.new(0.5, -15, 0, 27)
configUi.emojiBox.BackgroundColor3 = Color3.fromRGB(54, 32, 78)
configUi.emojiBox.BorderSizePixel = 0
configUi.emojiBox.ClearTextOnFocus = false
configUi.emojiBox.PlaceholderText = "Emoji: <:Mascota:id>"
configUi.emojiBox.PlaceholderColor3 = Color3.fromRGB(160, 133, 185)
configUi.emojiBox.Text = ""
configUi.emojiBox.TextColor3 = Color3.fromRGB(245, 235, 255)
configUi.emojiBox.Font = Enum.Font.Code
configUi.emojiBox.TextSize = 10
...
configUi.rarityButton.Position = UDim2.new(0.5, 5, 0, 194)
configUi.rarityButton.Size = UDim2.new(0.5, -15, 0, 27)
configUi.rarityButton.BackgroundColor3 = Color3.fromRGB(54, 32, 78)
...
configUi.saveButton.Position = UDim2.new(0, 10, 0, 226)
configUi.saveButton.Size = UDim2.new(0.5, -15, 0, 28)
configUi.saveButton.BackgroundColor3 = Color3.fromRGB(122, 57, 177)
configUi.saveButton.BorderSizePixel = 0
configUi.saveButton.Text = "SAVE PET  >  CONFIG"
configUi.saveButton.TextColor3 = Color3.fromRGB(255, 240, 255)
...
configUi.newButton.Position = UDim2.new(0.5, 5, 0, 226)
configUi.newButton.Size = UDim2.new(0.5, -15, 0, 28)
configUi.newButton.BackgroundColor3 = Color3.fromRGB(75, 45, 101)
...
configUi.deleteButton.Position = UDim2.new(0, 10, 0, 258)
configUi.deleteButton.Size = UDim2.new(1, -20, 0, 26)
configUi.deleteButton.BackgroundColor3 = Color3.fromRGB(86, 34, 64)
...
configUi.deleteButton.TextSize = 9
